...
from bro.version import __version__
from bro.scanner import exploits_from_mythril
from bro.file import exploits_from_file
from bro import *
...
def start_repl(args):
    ...
    from bro.exploit.exploit import Exploit
    from bro.exploit.tx import Tx

    # Imports for REPL
    import os, atexit, readline, rlcompleter

    # Load history
    history_path = os.path.join(os.environ["HOME"], ".bro_history")
...
https://github.com/tundachef/bro
